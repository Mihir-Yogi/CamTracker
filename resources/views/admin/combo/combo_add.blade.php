        ...
        <div class="wg-box">
            <form class="form-style-1" action="{{ route('admin.combos.store') }}" method="POST">
                ...
                <fieldset>
                    ...
                    <input type="text" name="nvr_model" value="{{ old('nvr_model') }}" required>
                    @error('nvr_model')
                ...
                <fieldset>
                    ...
                    <input type="text" name="nvr_serial_number" value="{{ old('nvr_serial_number') }}" required>
                ...
                <fieldset>
                    ...
                    <input type="text" name="dvr_model" value="{{ old('dvr_model') }}" required>
                    @error('dvr_model')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </fieldset>
                <fieldset>
                    ...
                    <input type="text" name="dvr_serial_number" value="{{ old('dvr_serial_number') }}" required>
