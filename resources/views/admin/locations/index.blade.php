        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form class="form-search" method="GET" action="{{ route('admin.locations.index') }}">
                        <fieldset class="name">
                            <input type="text" placeholder="Search here..." class="" name="name" tabindex="2" aria-required="true">
                        </fieldset>
                ...
                <a class="tf-button style-1 w208" href="{{ route('admin.locations.create') }}"><i class="icon-plus"></i>Add new</a>
            </div>
