...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <!-- Replace DVR Form -->
        <div class="wg-box">
            <form class="form-new-product form-style-2" style="gap: 20px;" action="{{ route('admin.dvrs.replace', $dvr->id) }}" enctype="multipart/form-data" method="POST">
                @csrf
                ...
                <div class="bot">
                    <div></div>
                    <button class="tf-button w208" type="submit">Replace DVR <span class="tf-color-1">*</span></button>
